...
namespace DotNetMQ.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<UserItemDto>>> All(Guid customerId)
        {
            ...
            var users = await _userManager.GetUsersForClaimAsync (_signInManager.Context.User.FindFirst( m=> m.Type==  DotNetMQClaimTypes.Customer && m.Value==customerId.ToString()));
