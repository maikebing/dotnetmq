...
using DotNetMQ.Communication.Messages;
using DotNetMQ.Exceptions;
using DotNetMQ.Serialization;

namespace DotNetMQ.Storage.MySqlStorage
{
    /// <summary>
    ...
    public class MySqlOdbcStorageManager : IStorageManager
    {
        ...
        private string _connectionString = "uid=root;server=localhost;driver={MySQL ODBC 3.51 Driver};database=mds;STMT=set names latin5";
